...
from models import Transaction, UploadedFile, User
from schemas import (
...
from services.file_parser_service import detect_file_type, parse_statement_file, validate_statement_file
    ...
    for row in upload_data.rows:
        ...
        transactions.append(
            Transaction(
                ...
                merchant=row.merchant or row.merchant_name,
